...
- Populating vector databases quickly, for instance using [Chroma DB's pytorch-based text embeddings](https://docs.trychroma.com/docs/embeddings/embedding-functions). For vector databases, a flat structure is often faster and less effort to use than JSON.
